...
template <class... Args>
inline std::string insert_sql(const std::string& table, Args&&... fields)
{
...
template <class... Args>
inline std::string update_by_pkey_sql(const std::string& table, Args&&... fields)
{
    // UPDATE contractor
...
template <class... Args>
inline std::string select_by_pkey_sql(const std::string& table, const std::string& pkey, Args&&... fields)
{
    size_t size = sizeof...(fields);
...
inline std::string select_by_pkey_sql(const std::string& table, const std::string& pkey)
{
...
inline std::string delete_by_pkey_sql(const std::string& table, const std::string& pkey)
{
...
template <class... Args>
inline std::string update_by_pkey_sql(const std::string& table, const std::string& pkey, Args&&... fields)
{
    // UPDATE contractor
