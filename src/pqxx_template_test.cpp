 ...
 * 
 * e.g. compile
 * g++ -O3 -DDEBUG -std=c++20 -pedantic-errors -Wall -Wextra -Werror pqxx_template_test.cpp -o ../bin/pqxx_template_test_runner -I../inc -I/usr/local/include -L/usr/local/lib -lpqxx -lpq -lgtest -lgtest_main -lpthread
 * g++ -O3 -DNDEBUG -std=c++20 -pedantic-errors -Wall -Wextra -Werror pqxx_template_test.cpp -o ../bin/pqxx_template_test_runner -I../inc -I/usr/local/include -L/usr/local/lib -lpqxx -lpq -lgtest -lgtest_main -lpthread
 */
#include "gtest/gtest.h"
#include <pqxx/pqxx>
// あなたの環境に合わせて正しいパスを指定してください
#include "pqxx_template.cpp" 
